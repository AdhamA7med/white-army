        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 space-x-reverse mb-6">
              ...
              <div>
                <h1 className="text-xl font-bold">الجيش الأبيض</h1>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:01115536294" className="text-white hover:text-blue-400 transition-colors">
                    01115536294
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:01015501710" className="text-white hover:text-green-400 transition-colors">
                    01015501710
                  </a>
                </div>
              </div>
