            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:01044839343" className="text-white hover:text-blue-400 transition-colors">
                    01044839343
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:01044839343" className="text-white hover:text-green-400 transition-colors">
                    01044839343
                  </a>
                </div>
              </div>
