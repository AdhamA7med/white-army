              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="tel:01070717801" className="text-blue-600 hover:text-blue-800 transition-colors">
                      01070717801
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="tel:01070717801" className="text-green-600 hover:text-green-800 transition-colors">
                      01070717801
                    </a>
                  </div>
                </div>
