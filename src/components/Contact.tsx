              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="tel:01115536294" className="text-blue-600 hover:text-blue-800 transition-colors">
                      01115536294
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <a href="tel:01015501710" className="text-green-600 hover:text-green-800 transition-colors">
                      01015501710
                    </a>
                  </div>
                </div>
